...
| planned | T21: worker coreがshutdownを優先し、bounded command batch、HCI/reply、due deadlineを飢餓なく処理し、T02 transport、T05 sender、残る M1 protocol の一時 `dead_code` 許可を削除する | worker unit | |
