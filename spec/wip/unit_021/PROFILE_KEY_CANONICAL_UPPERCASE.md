...
|---|---|---|---|---|
| todo | T01 canonical uppercase namespaceは受理し、lowercase / mixed-case namespaceはkey順序に依存せずsecret-freeな`InvalidProfile`になる | behavior / regression / edge | profile unit / public integration | 既存のlowercase正規化testをnamespaceとpeerへ先に分離する |
