...
pub const MAX_READ_SIZE: usize = 0x1D;
...
pub struct VirtualSpiFlash<M: ControllerModel> {
...
impl<M: ControllerModel> VirtualSpiFlash<M> {
    #[must_use]
    pub fn new(colors: Option<ControllerColors>) -> Self {
        Self {
    ...
    pub fn read(&self, address: u32, size: usize) -> Result<SpiRead, ProtocolError> {
